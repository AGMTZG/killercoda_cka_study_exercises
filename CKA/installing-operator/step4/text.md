...
- Identify the name of the Prometheus pod and port.

- Open an interactive shell inside it.

- Query the Prometheus HTTP API to confirm that your PodMonitor is detected and that metrics scraping is active.
...
wget -qO- http://localhost:9090/api/v1/targets | grep -i <your-podmonitor-name>
